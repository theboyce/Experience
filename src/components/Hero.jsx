    ...
    <div className="w-full h-screen">
      ...
      <div className='absolute top-0 w-full h-full flex flex-col justify-center text-white'>
        <div className='md:left-[10%] max-w-[1100px] m-auto absolute p-4'>
          ...
          <p className='max-w-[600px] drop-shadow-2xl py-2 text-xl'>Enjoy ipsum dolor sit amet consectetur adipisicing elit. Voluptate amet voluptatibus ipsum excepturi officiis numquam assumenda tempora ex blanditiis in?</p>
